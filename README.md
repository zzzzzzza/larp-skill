...
[快速开始](#-快速开始) · [安装](#安装) · [使用](#使用) · [项目结构](#项目结构)
...
| `larp-塑料温室_赵玄_to_崔昭贤` | 塑料温室 | 赵玄(NPC) → 崔昭贤 | [📦 下载](https://github.com/zzzzzzza/larp-skill/raw/main/example_skills/塑料温室_赵玄_to_崔昭贤.zip) |
| `larp-塑料温室_郑钧_to_郑卓英` | 塑料温室 | 郑钧(NPC) → 郑卓英 | [📦 下载](https://github.com/zzzzzzza/larp-skill/raw/main/example_skills/塑料温室_郑钧_to_郑卓英.zip) |
...
1. **下载**：[📦 下载 larp-skill.zip](https://github.com/zzzzzzza/larp-skill/archive/refs/heads/main.zip)
2. **添加技能**：在 Qoder Work 中，将下载的压缩包通过「安装技能」导入
3. **准备 PDF**：按[下方说明](#第一步准备-pdf-文件)准备好剧本 PDF 文件
4. **开始对话**：输入 `/create-larp-character`，跟着引导蒸馏你的角色
